                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="settings">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route("settings.user") }}" class="nav-link">User</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route("settings.role") }}" class="nav-link">Role</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route("settings.permissions") }}" class="nav-link">Permissions</a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            @can("SIDEBAR.MASTER")
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#master" role="button" aria-expanded="false"
                        ...
                        <span class="link-title">Master Barang & Obat</span>
                        <i class="link-arrow" data-feather="chevron-down"></i>
                    </a>
                    <div class="collapse" id="master">
                        <ul class="nav sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="{{ route("master.satuanBarang") }}" class="nav-link">Satuan Barang</a>
                            </li>
                        </ul>
                    </div>
                </li>
