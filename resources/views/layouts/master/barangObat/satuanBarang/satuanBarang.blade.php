...
@section("modal_content")
    <form id="satuanForm">
        ...
        <table class="table table-bordered" id="dynamicTable">
            ...
            <tr>
                <td><input type="text" name="addmore[0][kode_satuan]" placeholder="Masukkan Kode Satuan" class="form-control"
                        required /></td>
                <td><input type="text" name="addmore[0][satuan]" placeholder="Masukkan Satuan" class="form-control"
                        required /></td>
...
@section("content")
    ...
    @include("layouts.master.barangObat.satuanBarang.Editsatuan")

    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Satuan Table</li>
        </ol>
    </nav>

    @include("layouts.master.barangObat.satuanBarang.modal")
    @include("layouts.master.barangObat.satuanBarang.modalExcell")
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <button type="button" class="btn btn-info me-2" data-bs-toggle="modal"
                            ...
                            <i class="mdi mdi-note-plus "></i> Tambah Satuan
                        </button>
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#satuanExcellModal">
...
@section("scriptJS")
    @include("layouts.master.barangObat.satuanBarang.scriptJS")
@append
